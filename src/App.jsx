...
function BenachrichtigungenBanner({ session, onNavigateMeine }) {
  ...
  return (
    <div style={{ background: "#E6F1FB", border: "1.5px solid #B5D4F4", borderRadius: 12, padding: "11px 14px", marginBottom: 14, display: "flex", alignItems: "center", gap: 12 }}>
      <div style={{ width: 28, height: 28, background: "#185FA5", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
      ...
      <div style={{ flex: 1 }}>
        ...
        <div style={{ fontSize: 11, color: "#185FA5" }}>{ungelesen.map((b) => `${b.bucher_verein} · ${b.datum}`).join(" | ")}</div>
      </div>
      <button onClick={allesGelesen} style={{ padding: "6px 12px", background: "#185FA5", color: "white", border: "none", borderRadius: 8, fontSize: 11, fontWeight: 700, cursor: "pointer", flexShrink: 0 }}>
        Ansehen
      </button>
    </div>
  );
  ...
  return (
    <div style={{ maxWidth: 680, margin: "0 auto", padding: "1rem", fontFamily: "system-ui, -apple-system, sans-serif", color: "#1a1a1a", background: "#f0f2f5", minHeight: "100vh" }}>
      ...
      <div style={{ background: "white", border: "1.5px solid #e0e0e0", borderRadius: 14, padding: "12px 16px", display: "flex", alignItems: "center", gap: 10, marginBottom: 14, boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
        <div style={{ width: 36, height: 36, background: istSchiri ? "#7A5C00" : "#1D9E75", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20 }}>⚽</div>
        <div>
